const Section2_content = {
    ...
    Second_list2: "Electrodynamic Vibration Chamber will be moved up and down vertically through friction-free guided U channel and wheel.",
    Second_list3: "Electrodynamic Vibration Chamber will be moved horizontally manually using heavy duty castor wheel with railing.",
    Second_list4: "Multi-level diagonally joined airlock silicone rubber sealing the door and chamber with conduction free isolation mounts.",
    Second_list5: "Test chamber shall have illumination lamps with pre-set cut-off  timings.",
    Second_list6: "Insulated door with viewing window of size 400 x 500 / 500x 700  MM or suitable with condensation free heaters. Sensors for  detection of open door and safety shut-down of chamber operation  and alert message on the screen.",
    Second_list7: "xFeed-through holes: Two sizes of 75 mm diameter access ports with to connect the product during active test conditions.",
    Second_list8: "The vibration chamber shall be mounted on 4” Heavy-duty castor wheels and leveling pads ensuring easy erection &amp; movement of the system.",
    Second_list9: "Independent compartment will be provided for Refrigeration and  control system in one unit. Refrigeration system is designed  with Mechanical single stage / Cascade air/water cooled  refrigeration system using Hermetic/Semi hermetic compressors.  Refrigeration system comprises of control accessories such as  Heat exchanges, Solenoid, pressure controls, Expansion devices  etc., of reputed makes.",
  };
  
  export default Section2_content;
