        ...
        <div className="s3_wrapper">
            <div className="section3_cards">
                <div className="section3_card1">
                    ...
                    <p>Blower speed regulation to ensure metered uniform dust floating inside the Test space.</p>
                </div>
