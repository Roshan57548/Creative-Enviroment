...
const ContentIndustries = {
  ...
  card: [
    ...
    },
    {
      ...
      moreData_para4:
        "Vibration qualification tests, stress screening tests, and R&D tests are not only beneficial for the reliability of products, but often a required for various defense programs. Data Physics offers vibration test equipment for basic production test all the way to systems designed specifically for large scale aerospace applications – like NASA’s James Webb Space Telescope. Data Physics Electrodynamic Shakers and Vibration Controllers are commonly used for these tests.Multi-shaker tests are often run on extremely large payloads or for multiple degree of freedom simulation. Whether the application is large channel count vibration control or multi-shaker control, Data Physics Matrix Vibration Controllers are specifically designed for these demanding applications.Traditional vibration tables are not able to generate the energy needed to accurately reproduce many blast off and high air velocity conditions. For these tests, high amplitude acoustic power is generally needed using either a reverberant chamber or tube arrangement. High precision acoustic power generators (sometimes referred to as an electro-pneumatic transducer or EPT) are used to cover a wide range of frequencies at staggering levels. Data Physics offers High Intensity Acoustic Power Generators to cover both low and high frequency use.",
      moreData_para5:
    ...
    },
    {
      ...
      description1:
        "Many universities and research institutes in North America, Europe, and Asia use Data Physics products for noise and vibration or test and measurement research. Data Physics instruments are state of the art, propelling cutting edge research in universities.Additionally,leading university engineer...",
      description2:
        "Many universities and research institutes in North America, Europe, and Asia use Data Physics products for noise and vibration or test and measurement research. Data Physics instruments are state of the art, propelling cutting edge research in universities.Additionally, leading university engineering departments regularly work with Data Physics on a variety of academic projects, and Data Physics is open to new areas of joint research.",
      moreData_para1:
